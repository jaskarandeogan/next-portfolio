...
const ProfileSection = () => {
    return (
        <section className={classNames('flex',
            ...
            <Image src={"/images/Profile.png" || "https://firebasestorage.googleapis.com/v0/b/portfolio-e70ab.appspot.com/o/Profile-transformed.png?alt=media&token=28975845-aeb4-4a66-b66f-4b5a3e014860&_gl=1*14qwgkm*_ga*NzU2NzY3NjI5LjE2ODY1MzQ5MDI.*_ga_CW55HF8NVT*MTY5OTEyMzkxOC41LjEuMTY5OTEyNDA5NC41Ni4wLjA."} alt="Picture of the author" width={200} height={200} className="m-auto md:hidden rounded-full" />
