  ...
  return (
    <section className={classNames('flex', 'w-full', 'flex-col', 'gap-7')}>
      ...
      <p className='transition-all'>
        At Felix, my role as a web developer centered around devising software solutions for the <span className={classNames(isActive && 'text-primary-0 transition-all', 'font-medium transition-all')}>Marketing</span> department&apos;s unique challenges. I thrive on embracing fresh challenges and crafting innovative solutions to drive progress.
      </p>
